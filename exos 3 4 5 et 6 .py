...
#p=int(input("Votre poids : "))
#q=int(input("Quandtité de nourriture que vous mangez : "))
#i=int(input("nombre d'annimaux dans la comparaison : "))
#
#for i in range (1,i+1):
#    z[i]=int(input("poid de l'animal ",(i)))
#    y[i]=int(input("quantité de nourriture pour l'animal",(i)))
#    a[i+1]=int(input("poid de l'animal ",(i+1)))
#    x[i+1]=int(input("quantité de nourriture pour l'animal",(i+1)))
